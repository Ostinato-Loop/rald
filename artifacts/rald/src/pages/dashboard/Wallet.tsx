...
const MOCK_TRANSACTIONS: Transaction[] = [
  {
    ...
    status: "completed",
    time: "3 hr ago",
    ref: "PAY-2026051200001",
  },
  {
    id: "t2",
    type: "debit",
    desc: "Transfer to Chioma A.",
    amount: -12500,
    status: "completed",
    time: "1 day ago",
    ref: "TRF-2026051100023",
  },
  {
    id: "t3",
    type: "escrow",
    desc: "Escrow funded - Logo Design",
    amount: -25000,
    status: "pending",
    time: "2 days ago",
    ref: "ESC-2026050900011",
  },
  {
    id: "t4",
    type: "credit",
    desc: "Escrow released - Web Dev",
    amount: 85000,
    status: "completed",
    time: "5 days ago",
    ref: "ESC-2026050600003",
  },
  {
    id: "t5",
    type: "debit",
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">
          Manage your NGN wallet, transfers, and escrow
        </p>
      </div>
      ...
      <div className="bg-card border border-border rounded-xl">
        ...
        <div className="divide-y divide-border">
          {isLoading ? (
            [1, 2, 3, 4].map((i) => (
              <Skeleton key={i} className="h-16 m-3 rounded-lg" />
            ))
          ) : filtered.length === 0 ? (
            ...
            filtered.map((t) => (
              ...
              >
                <div
                  className={`w-9 h-9 rounded-lg flex items-center justify-center shrink-0 ${t.amount > 0 ? "bg-green-500/10" : "bg-red-500/10"}`}
                >
                  {t.amount > 0 ? (
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    <span
                      className={`text-[10px] px-1.5 py-0.5 rounded font-medium ${statusClasses[t.status]}`}
                    >
                      {t.status}
                    </span>
                ...
                <div className="text-right shrink-0">
                  <p
                    className={`text-sm font-semibold font-mono ${t.amount > 0 ? "text-green-500" : "text-foreground"}`}
                  >
                    {t.amount > 0 ? "+" : ""}
                    {fmt.ngn(Math.abs(t.amount))}
                  </p>
