    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className={`p-2 rounded-lg ${color || "bg-primary/10"}`}>
          <Icon
            className={`w-4 h-4 ${color ? "text-white" : "text-primary"}`}
          />
        </div>
      </div>
      <div>
...
export default function Overview() {
  ...
  const activities: ActivityItem[] =
    activityData?.activities ?? MOCK_DATA.activities;
          ...
          {[
            {
              ...
              sub: "Devices logged in",
              color: "bg-blue-500",
            },
            {
              icon: Shield,
              label: "Security Status",
              value: stats.security === "strong" ? "Strong" : "Review needed",
            ...
            },
            {
              ...
              value: fmt.ngn(stats.walletBalance),
            ...
            : activities.map((a) => (
                ...
                >
                  ...
                  <div className="text-right shrink-0">
                    {a.amount && (
                      <p
                        className={`text-sm font-semibold ${a.amount.startsWith("+") ? "text-green-500" : "text-red-500"}`}
                      >
                        {a.amount}
                      </p>
                    )}
