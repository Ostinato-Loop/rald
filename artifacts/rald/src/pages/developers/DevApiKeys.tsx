...
const MOCK_DEV_KEYS = [
  {
    id: "dk1",
    name: "Loop Workspace Production",
    key: "rald_sk_live_devA1B2C3D4E5F6G7H8",
    scopes: ["profile:read", "session:write", "wallet:read"],
    lastUsed: "2 min ago",
    created: "Jan 15, 2026",
    requests: 12841,
  },
  {
    id: "dk2",
    name: "Mobile App Test Key",
    key: "rald_sk_test_devZ9Y8X7W6V5U4T3S2R1",
    scopes: ["profile:read"],
    lastUsed: "1 day ago",
    created: "Mar 10, 2026",
    requests: 342,
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            Server-side keys for authenticating API requests
          </p>
        </div>
        <button
            ...
            {ALL_SCOPES.map((s) => (
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    setSelectedScopes((sc) =>
                      e.target.checked ? [...sc, s] : sc.filter((x) => x !== s),
                    )
                  }
                  className="rounded"
                />
