    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">
          Your current plan and usage-based billing estimate
        </p>
      </div>
      ...
      <div className="bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 rounded-xl p-6 space-y-3">
        ...
        <div className="grid grid-cols-3 gap-4 pt-2">
          {[
            { label: "API Requests", limit: "100,000 / mo", used: "14,821" },
            { label: "OTP Sends", limit: "10,000 / mo", used: "4,632" },
            { label: "Team Members", limit: "Unlimited", used: "1" },
      ...
      <div className="bg-card border border-border rounded-xl p-5 space-y-4">
        ...
        <p className="text-xs text-muted-foreground">
          Free tier — no charges until limits are exceeded
        </p>
      </div>
          ...
          {INVOICES.map((inv) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <span
                  className={`text-xs px-2 py-0.5 rounded-full capitalize ${inv.status === "paid" ? "bg-green-500/10 text-green-600 dark:text-green-400" : "bg-blue-500/10 text-blue-500"}`}
                >
                  {inv.status}
                </span>
              </div>
