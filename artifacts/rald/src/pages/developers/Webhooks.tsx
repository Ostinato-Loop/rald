...
const MOCK_WEBHOOKS = [
  {
    id: "wh1",
    url: "https://workspace.ostloop.ng/webhooks/rald",
    events: ["user.login", "session.created"],
    status: "active",
  ...
  {
    id: "wh2",
    url: "https://hooks.zapier.com/hooks/catch/12345678/abcdef",
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-xs bg-green-500/10 text-green-600 dark:text-green-400 px-2 py-0.5 rounded-full shrink-0">
                    {hook.status}
                  </span>
                </div>
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="flex items-center gap-1 px-2.5 py-1 border border-border text-xs text-foreground rounded-lg hover:bg-muted"
                  data-testid={`test-webhook-${hook.id}`}
                >
