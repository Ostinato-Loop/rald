    ...
    <div className="max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">
          API usage breakdown, latency metrics, and quota status
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          ...
          <div
            ...
            data-testid={`quota-${label.replace(/\s/g, "-").toLowerCase()}`}
          >
              ...
              <div className="w-40">
                <div className="w-full h-1.5 bg-muted rounded-full overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${(ep.requests / BY_ENDPOINT[0].requests) * 100}%`,
                    }}
                  />
                </div>
              </div>
              <span className="text-xs text-foreground font-mono w-16 text-right">
