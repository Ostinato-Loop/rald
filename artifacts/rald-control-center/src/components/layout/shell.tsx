    ...
    <div className="flex min-h-screen w-full bg-background dark text-foreground">
      <aside className="w-64 border-r border-border bg-sidebar flex flex-col">
        <div className="h-16 flex items-center px-6 border-b border-border">
          ...
          <span className="font-bold text-lg tracking-tight uppercase tracking-wider">RALD Command</span>
        </div>
        ...
        <div className="p-4 border-t border-border mt-auto">
          <div className="flex items-center mb-4 px-2">
            <div className="w-8 h-8 bg-muted border border-border flex items-center justify-center text-xs font-bold mr-3">
